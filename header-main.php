 ...
 -->
	...
	<div class="container">
		...
		<div class="slider_items">
			...
			<img data-lazy="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/123.jpg"  alt="slide">
			<div class="news_line">
				<div class="wrapper_middle_action">
					ТУТ БУДЕТ СКИДКА ИЛИ НОВОСТЬ
				</div>
			</div>
		</div>
	<!-- 	<div class="slider_items">
			<img data-lazy="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/22.jpg"  alt="slide">
		</div> -->
		<div class="slider_items">
			<img data-lazy="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/33.jpg"  alt="slide">
			<div class="news_line">
				<div class="wrapper_middle_action">
					ИЛИ ТУТ БУДЕТ
				</div>
